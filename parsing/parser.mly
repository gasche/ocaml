...
fun_expr:
  ...
  | pbop_op = mkrhs(LETOP) pbop_attributes = attributes bindings = letop_bindings IN body = seq_expr
      { let (pbop_pat, pbop_expr, rev_ands) = bindings in
        let ands = List.rev rev_ands in
        let pbop_loc = make_loc $sloc in
        let let_ = {pbop_op; pbop_pat; pbop_expr; pbop_loc; pbop_attributes; } in
...
letop_bindings:
    body = letop_binding_body
      { let let_pat, let_exp = body in
        let_pat, let_exp, [] }
  | bindings = letop_bindings pbop_op = mkrhs(ANDOP) pbop_attributes = attributes body = letop_binding_body
