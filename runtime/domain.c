...
/* During a stop-the-world (STW), all currently running domains stop
   ...
   be "protected by STW" if it is only mutated within STW section, and
   read outside the sections or, within the STW section, after an
   explicit barrier following the mutation.
*/
