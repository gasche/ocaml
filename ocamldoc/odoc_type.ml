...
type variant_constructor = {
    ...
    modifiable vc_text : Odoc_types.info option ; (** optional user description *)
  }
...
type record_field = {
    ...
    modifiable rf_text : Odoc_types.info option ; (** optional user description *)
  }
...
type t_type = {
    ty_name : Name.t ;
    modifiable ty_info : Odoc_types.info option ; (** optional user information *)
    ...
    modifiable ty_loc : Odoc_types.location ;
