...
N.B. for this to work properly, you need to have run the configure script, and
the workspace needs to be clean (otherwise dune will complain that build
artefacts are present among the sources).
