...
let primitive ppf = function
  ...
  | Patomic_load_field -> fprintf ppf "atomic_load_field"
  | Patomic_exchange_field -> fprintf ppf "atomic_exchange_field"
  | Patomic_cas_field -> fprintf ppf "atomic_cas_field"
