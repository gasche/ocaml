...
type reloc_info =
    Reloc_literal de Lambda.structured_constant    (* structured constant *)
  | Reloc_getglobal de Ident.t              (* reference to a global *)
  | Reloc_setglobal de Ident.t              (* definition of a global *)
  | Reloc_primitive de string               (* C primitive number *)

(* Descriptor for compilation units *)

type compilation_unit =
  { cu_name: string;                    (* Name of compilation unit *)
    modifiable cu_pos: int;                (* Absolute position in file *)
    cu_codesize: int;                   (* Size of code block *)
    cu_reloc: (reloc_info * int) list;  (* Relocation information *)
    cu_imports: (string * Digest.t) list; (* Names and CRC of intfs imported *)
    cu_primitives: string list;         (* Primitives declared inside *)
    modifiable cu_force_link: bool;        (* Must be linked even if unref'ed *)
    modifiable cu_debug: int;              (* Position of debugging info, or 0 *)
